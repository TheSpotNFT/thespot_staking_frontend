      ...
      <div className="px-6 py-4">
        ...
        <div className="text-slate-50 text-base">
          ...
          <div className="flex grid gap-2 py-2 pt-5 place-contents-center">
            <div className="pb-2"><input type="number"
              className="border-2 border-slate-600 bg-slate-400 text-left font-mono placeholder-slate-600 pl-2 w-24" placeholder="Quantity"
              value={quantityInput}
              onChange={quantityInputUser.bind(this)}
            /></div>
            <Mint
